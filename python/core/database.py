...
async def init_tables():
    ...
    -- 4. Workflow Stitched ARDs Table
    CREATE TABLE IF NOT EXISTS workflow_ards (
        id SERIAL PRIMARY KEY,
    ...
    -- Index for fast ARD lookups and version tracking
    CREATE INDEX IF NOT EXISTS idx_workflow_ards_lookup 
    ON workflow_ards (workflow_id, grain, version DESC);
    """
